...
const config = {
	...
	operators: [
		{ label: '+', operation: 'add', position: '0vmin -24vmin' },
		{ label: '-', operation: 'subtract', position: '-8vmin -24vmin' },
		{ label: '/', operation: 'divide', position: '-16vmin -24vmin' },
		{ label: '*', operation: 'multiply', position: '-24vmin -24vmin' },
		{ label: '=', operation: 'compute', position: '0vmin -32vmin' },
		{ label: '.', operation: 'decimalValue', position: '-8vmin -32vmin' },
